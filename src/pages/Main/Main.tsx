...
function Main() {
  return (
    <div style={{ display: "flex", flexDirection: "column", width: "100%", alignSelf: "start" }}>
      <MainHeader />
      <CardWheel title={"Мои соревнования"} items={Array(6).fill(<CompetitionCard {...cardProps} />)} />
      <CardWheel title={"Новые соревнования"} items={Array(6).fill(<CompetitionCard {...cardProps} />)} />
    </div>
  );
}
